@page Tut_DatafileFromScratch Datafile from scratch

In this section, we will recreate step by step the data file used in a previous tutorial.
...
Also, check out our **[YouTube](https://www.youtube.com/@ceatrustplatform8802)** channel.

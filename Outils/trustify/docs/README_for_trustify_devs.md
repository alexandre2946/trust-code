@page Trustify_ForTrustifyDevs trustify — guide for trustify developers
...
If you need to run a single unit test in Debug mode, install trustify
(`make install-dev` for an editable install) and invoke Python unittest
like this:
